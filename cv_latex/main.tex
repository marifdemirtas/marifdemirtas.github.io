...
\begin{document}
    ...
    % \end{onecolentry}
    \section{Summary}
    I'm \textbf{Arif} (he/him)! In my research, I develop and evaluate systems to support instructors and students using generative AI models through human-centered design. My work focuses on computing education, specifically for students who are from fields other than Computer Science.
     ...
     %  \vspace{.5em}    
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Evaluated the impact of the tool in a mixed-methods user study, to appear in \textbf{AIED 2026}~\cite{aied2026}
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Teaching}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Mentored more than 30 students in 4-week periods over a year
            \end{highlights}
        \end{onecolentry}
...
\section{Honors \& Awards}
    \begin{onecolentry}
        \begin{highlights}
            \item \textbf{Future Leaders of AI}, ACM AI Summit (\$1250), \textit{2026}.
            \item \textbf{Doctoral Consortium Travel Funding}, EDM 2024 (\$2500), \textit{2024}.
        \end{highlights}
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item  \textit{Building a community of practice to support programming education across engineering departments}. Strategic Instructional Innovations Program, The Grainger College of Engineering (\$6500). \textit{2026}.
            \begin{itemize}
